...
def myModel():
    ...
    #conv0 = tf.keras.layers.Conv2D(64,3,strides=(1,1), padding="valid", activation='relu',input_shape=(50,50,1))(inputs)
    #conv0 = tf.keras.layers.Conv2D(64,3,strides=(1,1), padding="valid", activation='relu',)(conv0)
    #conv0 = tf.keras.layers.Conv2D(64,3,strides=(1,1), padding="valid", activation='relu',)(conv0)
    #conv0 = tf.keras.layers.Conv2D(64,3,strides=(1,1), padding="valid", activation='relu',)(conv0)

    #64*48*48 ->128*48*48 ->128*24*24
    conv1 = ResnetIdentityBlock(3,[64,64,64])(conv0)
    #conv1 = tf.keras.layers.MaxPool2D(pool_size=(2,2), strides=(2,2))(conv1)
    #128*24*24 ->256*24*24->256*12*12
    conv2 = ResnetIdentityBlock(3,[64,64,64])(conv1)
    ...
    conv1_ = InverseResnetIdentityBlock(3,[64,64,64])(conv2)
    #conv1_ = tf.keras.layers.UpSampling2D(size=(2,2))(conv1_)
    #conv1_ = tf.keras.layers.Add()([conv1, conv1_])

    conv0_ = InverseResnetIdentityBlock(3,[64,64,64])(conv1_)
    #conv0_ = tf.keras.layers.UpSampling2D(size=(2,2))(conv0_)
    #conv0_ = tf.keras.layers.Add()([conv0, conv0_])
    conv0_ = tf.keras.layers.Conv2DTranspose(1,9,strides=(1,1), padding="valid",dilation_rate=(1,1), activation='relu')(conv0_)
    #conv0_0 = tf.keras.layers.Conv2DTranspose(1,3,strides=(1,1), padding="valid",dilation_rate=(1,1), activation='relu')(conv0_)
    #conv0_0 = tf.keras.layers.Conv2DTranspose(1,3,strides=(1,1), padding="valid",dilation_rate=(1,1), activation='relu')(conv0_0)
    #conv0_0 = tf.keras.layers.Conv2DTranspose(1,3,strides=(1,1), padding="valid",dilation_rate=(1,1), activation='relu')(conv0_0)
    ...
    e_output = tf.keras.layers.Conv2D(1,1,strides=(1,1), padding="valid",dilation_rate=(1,1), activation='relu', name='enhancementOutput')(conv0_)
