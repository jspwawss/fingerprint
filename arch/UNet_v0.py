...
def myModel():
    ...
    conv1_ = InverseResnetIdentityBlock(3,[256,128,128])(conv2_)
    ...
    e_output = tf.keras.layers.Conv2D(1,1,strides=(1,1), padding="valid", activation='relu', name='enhancementOutput')(inputs_)
