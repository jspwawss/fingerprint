...
def myModel():
    ...
    conv1 = tf.keras.layers.Conv2D(64,5,strides=(1,1), padding="valid", activation='relu',input_shape=(50,50,1))(conv0)

    conv2 = ResnetIdentityBlock(3,[64,64,64])(conv1)

    conv3 = ResnetIdentityBlock(3,[64,64,64])(conv2)

    conv2_ = InverseResnetIdentityBlock(3,[64,64,64])(conv3)
    conv2_ = tf.keras.layers.Add()([conv2,conv2_])
    conv1_ = InverseResnetIdentityBlock(3,[64,64,64])(conv2_)
